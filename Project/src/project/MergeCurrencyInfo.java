...
public class MergeCurrencyInfo {
    private static final Logger logger = LogManager.getLogger(MergeCurrencyInfo.class);
    
    public static void main(String[] args) {
        try {
            mergeCurrencyInfo("nazwy_walut.txt", "bid_ask.txt", "merged_currency_info.txt");
            logger.debug("merged done corectly");
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private static Map<String, String> readCurrencyInfo(String filePath) throws IOException {
        ...
        logger.debug("currencyInfoMap created");
    ...
    private static Map<String, String> readBidAskInfo(String filePath) throws IOException {
        ...
        logger.debug("bisAskMap created");
        return bidAskMap;
    }
}
